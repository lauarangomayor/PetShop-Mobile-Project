...
namespace PetShopApp.ViewModels
{
    class MyListPageViewModel
    {
        ...
        public MyListPageViewModel()
        {
            ...
            FoodList.Add(new MyListModel { Name = "Test1", Image = "https://image.shutterstock.com/image-photo/fresh-tasty-burger-isolated-on-260nw-705104968.jpg", Detail = "This is a burger 1", Ingredients="This is our detail page 1. Cheese, Bacon, Tomato" });
            FoodList.Add(new MyListModel { Name = "Test2", Image = "https://image.shutterstock.com/image-photo/fresh-tasty-burger-isolated-on-260nw-705104968.jpg", Detail = "This is a burger 2", Ingredients = "This is our detail page 2. Cheese, Bacon, Tomato" });
            FoodList.Add(new MyListModel { Name = "Test3", Image = "https://image.shutterstock.com/image-photo/fresh-tasty-burger-isolated-on-260nw-705104968.jpg", Detail = "This is a burger 3", Ingredients = "This is our detail page 3. Cheese, Bacon, Tomato" });
            FoodList.Add(new MyListModel { Name = "Test4", Image = "https://image.shutterstock.com/image-photo/fresh-tasty-burger-isolated-on-260nw-705104968.jpg", Detail = "This is a burger 4", Ingredients = "This is our detail page 4. Cheese, Bacon, Tomato" });
            FoodList.Add(new MyListModel { Name = "Test5", Image = "https://image.shutterstock.com/image-photo/fresh-tasty-burger-isolated-on-260nw-705104968.jpg", Detail = "This is a burger 1", Ingredients = "This is our detail page 1. Cheese, Bacon, Tomato" });
