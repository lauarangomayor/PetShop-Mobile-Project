...
namespace PetShopApp.ViewModels
{
    class HomeShopViewModel : ViewModelBase
    {
        ...
        public HomeShopViewModel()
        {
            ...
            ProductsList.Add(new ProductModel { ID = 1, Name = "Kit completo", Description="Incluye cepillos, cortauñas y un maletin.", UnitPrice = 53600,Category= new CategoryModel { IdCategory = 1,Name= "Aseo"}, Stock = 1, StateProduct = new StateProductModel { IdStateProduct =1, Description="Creado"},Image = "https://sc01.alicdn.com/kf/HTB1HZOiaLjsK1Rjy1Xaq6zispXaP.jpg" });
